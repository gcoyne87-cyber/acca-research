// Unscheduled trigger twin for fetch-horse-history-2-background.js — same
...
// fetch-horse-history-2-background.js has no internal x-build-secret check of
...
exports.handler = async function(event) {
  ...
  return require('./fetch-horse-history-2-background.js').handler(event);
};
