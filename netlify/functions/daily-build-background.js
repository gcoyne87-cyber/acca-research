...
---
OUTPUT RULES:
- raceIntelligence: sharp pre-race briefing. Maximum 60 words, never exceed 60 words. Cover only: genuine contender count, the key filter today (going, class, or trip), and the standout pattern. Do NOT mention your selection. Do NOT mention tipsters.
...
{
  "raceIntelligence": "string — maximum 60 words, never exceed 60 words, sharp briefing, no tipster attribution, do not mention your selection",
  "confidenceScore": 7.3,
  "strongestSelection": {
    "horseName": "string",
    "odds": "string",
