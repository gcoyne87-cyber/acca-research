...
3. Search "[jockey name] recent winners 2026" — is jockey in a purple patch or going cold?
...
7. ★ Jockeys who ride certain horses better than their official partnership suggests
...
13. Trainer running multiple horses — jockey booking tells you which one the yard is serious about
...
- strongestSelection.factors: exactly 3 entries — choose the 3 most compelling reasons for this specific horse from these categories: JOCKEY, GOING, FORM, TRAINER, DRAW, CLASS, DISTANCE, COURSE, MARKET, WEIGHT. Pick whichever 3 are most relevant and impactful for this race. Each factor must start with the category label in uppercase followed by a space then the explanation, e.g. "JOCKEY Townend retained on merit — not rotation", "GOING Won twice on Heavy, conditions suit perfectly", "FORM Four from five, only defeat a Grade 1 second"
