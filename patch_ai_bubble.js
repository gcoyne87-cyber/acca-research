...
//    - Wrap AI EDGE badge + text in a tinted bubble
// ════════════════════════════════════════════════════════════════════════
...
// Header — no bottom border, flows straight into bubble below
...
// AI bubble — badge + research text in one tinted rounded container
'      +\'<div style="margin:0 14px 14px;background:#edf7f1;border:1px solid #c3e6d0;border-radius:10px;padding:11px 13px">\'\n',
'        +\'<div style="display:inline-flex;align-items:center;gap:4px;margin-bottom:7px;background:#0b1628;border:1.5px solid #c9a84c;border-radius:5px;padding:3px 8px">\'\n',
...
// ════════════════════════════════════════════════════════════════════════
// 2. Replace tomorrow's static cards with same layout
// ════════════════════════════════════════════════════════════════════════
const AI_BUBBLE_OPEN='<div style="margin:0 14px 14px;background:#edf7f1;border:1px solid #c3e6d0;border-radius:10px;padding:11px 13px">'
  +'<div style="display:inline-flex;align-items:center;gap:4px;margin-bottom:7px;background:#0b1628;border:1.5px solid #c9a84c;border-radius:5px;padding:3px 8px">'
  +'<div style="width:5px;height:5px;border-radius:50%;background:#1e9e6b;flex-shrink:0"></div>'
  +'<span style="font-size:9px;font-weight:700;letter-spacing:0.1em;color:#fff">AI EDGE</span>'
  +'</div>';
...
// ════════════════════════════════════════════════════════════════════════
// 3. Carousel strips — white outer, bubble around message text
// ════════════════════════════════════════════════════════════════════════

// Today: change strip background to white, wrap message div in bubble
html=html.replace(
  'id="ai-feed-strip" style="margin:0 12px 0;border-radius:10px 10px 0 0;overflow:hidden;position:relative;background:#f4fbf7;border:1px solid #d4edd9;border-bottom:none"',
  'id="ai-feed-strip" style="margin:0 12px 0;border-radius:10px 10px 0 0;overflow:hidden;position:relative;background:#fff;border:1px solid #e0e4ea;border-bottom:none"'
);
html=html.replace(
  '<div style="padding:2px 12px 12px">\n      <div id="ai-feed-msg" style="font-size:13.5px;color:#1e7a54;font-weight:500;line-height:1.4;overflow:hidden"></div>\n      </div>',
  '<div style="padding:4px 12px 12px">'
  +'<div style="background:#edf7f1;border:1px solid #c3e6d0;border-radius:10px;padding:11px 13px">'
  +'<div id="ai-feed-msg" style="font-size:13px;color:#1e7a54;font-weight:500;line-height:1.5;overflow:hidden"></div>'
  +'</div></div>'
);

// Tomorrow: same treatment
html=html.replace(
  'id="ai-feed-strip-tomorrow" style="margin:0 12px 0;border-radius:10px 10px 0 0;overflow:hidden;position:relative;background:#f4fbf7;border:1px solid #d4edd9;border-bottom:none"',
  'id="ai-feed-strip-tomorrow" style="margin:0 12px 0;border-radius:10px 10px 0 0;overflow:hidden;position:relative;background:#fff;border:1px solid #e0e4ea;border-bottom:none"'
);
html=html.replace(
  '<div style="padding:2px 12px 12px">\n      <div id="ai-feed-msg-tomorrow" style="font-size:13.5px;color:#1e7a54;font-weight:500;line-height:1.4;overflow:hidden"></div>\n    </div>',
  '<div style="padding:4px 12px 12px">'
  +'<div style="background:#edf7f1;border:1px solid #c3e6d0;border-radius:10px;padding:11px 13px">'
  +'<div id="ai-feed-msg-tomorrow" style="font-size:13px;color:#1e7a54;font-weight:500;line-height:1.5;overflow:hidden"></div>'
  +'</div></div>'
);

console.log('3. Carousel strips updated');
